...
extern "C" void HAL_UARTEx_RxEventCallback(UART_HandleTypeDef *huart, uint16_t Size)
{
    if (huart->Instance == USART6)
    {
        ...
        { 
            HAL::UART::Data DT7Rx_data{DT7Rx_buffer, Size};
            uart6.trigger_rx_callbacks(DT7Rx_data);

            HAL::UART::Data dma_listen{DT7Rx_buffer, 18};
            uart6.receive_dma_idle(dma_listen);
            uart6.clear_ore_error(dma_listen);
        }
    }
